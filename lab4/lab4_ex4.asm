...
DO_WHILE_LOOP
	...
	ADD R1, R1, R1			;value being added by itself 
	ADD R4, R4, #-1			;Subtract the size by 1
	BRnp DO_WHILE_LOOP		;if it isn't positive, end loop
END_WHILE_LOOP

LD R6, DATA_PTR
ADD R6, R6, #6				;getting the 7th element
...
NUMBER	.FILL	#1			;fills dec_0 with 0
SIZE	.FILL	#10			;size of array
NEWLINE	.FILL	'\n'		;newline
